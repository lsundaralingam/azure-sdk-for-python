...
class CommunicationIdentityOperations(object):
    ...
    def create_identity(
        self,
        create_token_with_scopes=None,  # type: Optional[List[Union[str, "models.CommunicationTokenScope"]]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.CommunicationIdentityAccessTokenResult"
    ...
    def issue_access_token(
        self,
        id,  # type: str
        scopes,  # type: List[Union[str, "models.CommunicationTokenScope"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.CommunicationUserToken"
